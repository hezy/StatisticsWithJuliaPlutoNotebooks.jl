...
# ╔═╡ 88b39904-9d63-4329-9257-7f3f907c1a4d
matchExists1(n) = 1 - prod([k/365 for k in 365:-1:365-n+1])

# ╔═╡ c1b14c01-22b1-456c-99ef-76e2c253bbd7
...
# ╔═╡ 2ed3bbfa-5437-44d8-80c6-e3f1f8ca6bfd
probEst(n) = sum([bdEvent(n) for _ in 1:N])/N

# ╔═╡ d5cf5c33-0ccf-4f63-bb58-86066a59669f
xGrid = 1:50

# ╔═╡ 30f8dd58-d030-481c-9e97-afdb8aed6159
analyticSolution1 = [matchExists1(n) for n in xGrid]

# ╔═╡ 054a3bdb-21c7-4a2b-9cd0-704413e465bb
analyticSolution2 = [matchExists2(n) for n in xGrid]

# ╔═╡ 41d403d2-aedb-4dd6-a8b4-637dbf41b4db
("Maximum error: $(round(maximum(abs.(analyticSolution1 - analyticSolution2)), digits=25))")

# ╔═╡ 11dcb82b-f610-4a2a-a92a-d2ab577b52db
mcEstimates = [probEst(n) for n in xGrid]

# ╔═╡ 8ad1d0f6-219c-4f6a-939b-b77b62c2da28
begin
	plot(xGrid, analyticSolution1, c=:blue, label="Analytic solution")
	scatter!(xGrid, mcEstimates,
			c=:red, ms=3, msw=3, shape=:xcross, label="MC estimation",
			xlims=(0,50), ylims=(0,1),
...
manifest_format = "2.0"
project_hash = "43590a0e64419d8e1ccefc2ef44dd1ae909192bb"
