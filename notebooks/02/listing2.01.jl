...
# ╔═╡ 512b2980-3539-497c-8774-89ec6da56024
N, faces = 10^6, 1:6

# ╔═╡ 8db85b4f-31b5-4d64-9282-528369eb94f9
numSol = sum([iseven(i+j) for i in faces, j in faces]) / length(faces)^2

# ╔═╡ e764d507-00fe-45ae-98ca-9b8eee53beaa
...
manifest_format = "2.0"
project_hash = "b044e8a6a69cba0e63f841fad45af211b290d5d2"
